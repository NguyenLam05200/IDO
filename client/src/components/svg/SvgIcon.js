const FutureInsurance = ({ size }) => (
  ...
  >
    <path
      d="M12.231 2.4 5.6 6.261V9.27l6.631-3.956 6.625 3.956V6.261l-6.625-3.86z"
      fill={"#EB2B3D"}
    />
    <path
...
const ArrowDownIcon = ({ className = "", color = "#8694B3" }) => (
  ...
  >
    <g clipPath="url(#clip0_295_61062)">
      <path
        d="M11.3333 9.33337L7.99992 6.00004L4.66659 9.33337L11.3333 9.33337Z"
        fill={color}
      />
    </g>
    <defs>
...
const SeeIcon = ({ className, color, size }) => {
  const defaultColor = true ? "#8694b2" : "#768394";
    ...
    >
      <g clipPath="url(#5aan4m2usa)" fill={color || defaultColor}>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M23 2 2 23l-.884-.884 21-21L23 2z"
        />
      </g>
      <defs>
...
const SwapIcon = ({ className = "", color, size = 16 }) => {
  const defaultColor = true ? "#E2E8F0" : "#1E1E1E";
    ...
    >
      {isFilled ? (
        <g clipPath="url(#ixety35iha)">
          <path
            d="M4.666 6.667 7.999 10l3.334-3.333H4.666z"
            fill={color || defaultColor}
          />
        </g>
      ) : (
        <g clipPath="url(#evihhgi6wb)">
          <path
            d="m18 10-1.41-1.41L12 13.17 7.41 8.59 6 10l6 6 6-6z"
            fill={color || defaultColor}
          />
        </g>
      )}
...
const FutureWalletIcon = ({ size = 36, ...props }) => (
  ...
  >
    ...
    />
    <path
      d="M11.6048 9.63709L10.8516 8.84961H12.3826L11.6048 9.63709Z"
      fill="#0D994E"
    />
    <path
    ...
    />
    <path
      d="M20.3419 13.3809H18.7617V17.0595H20.3419V13.3809Z"
      fill="#9FF2C6"
    />
    <path
      d="M21.8998 13.3809H20.3359V17.0595H21.8998V13.3809Z"
      fill="#0D994E"
    />
  </svg>
);
const FutureTransferIcon = ({ size = 36, ...props }) => (
  ...
  >
    <path
      d="M14.4142 14.9962V15.0572H9.58984L12.0291 12.3672L14.4142 14.9962Z"
      fill="#0D994E"
    />
    <path
      d="M9.58984 9.68555L12.0291 12.3823L14.4142 15.0181V9.7533V9.68555H9.58984Z"
      fill="#9FF2C6"
    />
    <path d="M9.58594 7.0362V9.68555H18.4555V7.0362H9.58594Z" fill="#5BD891" />
    <path
      d="M21.5969 8.39197L17.6602 4.80078V11.9764L21.5969 8.39197Z"
      fill="#5BD891"
    />
    <path d="M5.54297 15.046V17.6953H14.4125V15.046H5.54297Z" fill="#5BD891" />
    <path
      d="M2.39844 16.3627L6.32842 12.7715V19.9471L2.39844 16.3627Z"
      fill="#5BD891"
    />
  </svg>
);
...
const FutureExchangeIcon = ({ size = 36, ...props }) => (
  ...
  >
    <path
      d="M7.191 21.6H2.398V16.81L7.191 21.6zM16.805 2.398h4.793V7.19l-4.793-4.792z"
      fill="#5BD891"
    />
    <path
...
const FutureReferralIcon = ({ size = 36, ...props }) => (
  ...
  >
    ...
    />
    <path
      d="m14.91 10.505-3.986 4.801-1.756-1.826 3.986-4.734 1.756 1.758z"
      fill="#0D994E"
    />
    <path
...
const FutureIcon = ({ size = 36, ...props }) => {
  return (
    ...
    >
      {" "}
      <path
        d="M3.2 28.796h25.595V10.361l-10.459 9.434-8.643-2.211-6.494 6.139v5.073z"
        fill="#9FF2C5"
      />
...
const FutureAdvanceIcon = ({ size, ...props }) => (
  ...
  >
    ...
    <path
      d="M19.124 13.9007L15.6406 16.6715V11.209L19.124 13.9007Z"
      fill="#5BD891"
    />
    <path d="M11.2083 7.25H2.5V21.5H11.2083V7.25Z" fill="#5BD891" />
    <path
      d="M8.27917 11.1289V16.5914L4.875 13.8997L8.27917 11.1289Z"
      fill="#0D994E"
    />
  </svg>
);
...
const SuccessfulTransactionIcon = ({ size = 36, ...props }) => {
  ...
  return isDark ? (
    ...
    >
      ...
      />
      <path
        d="M20.5132 22.1334C19.9412 17.8616 16.2803 14.666 11.9656 14.666V22.1007H3.41797V22.1334H20.5132Z"
        fill="#E2E8F0"
      />
      <path
        d="M11.95 14.666C7.63531 14.6823 3.97437 17.8616 3.40234 22.1334H11.9663L11.95 14.666Z"
        fill="#0C0E14"
      />
      <path
      ...
      />
      <path
        d="M22.1965 22.1817H17.6367V20.16H20.17V17.6328H22.1965V22.1817Z"
        fill="#47ED95"
      />
      <path
        d="M6.36062 22.1817H1.80078V17.6328H3.82738V20.16H6.36062V22.1817Z"
        fill="#47ED95"
      />
      <path
        d="M3.82738 6.38355H1.80078V1.81836H6.36062V3.84008H3.82738V6.38355Z"
        fill="#47ED95"
      />
      <path
        d="M22.1965 6.38355H20.17V3.84008H17.6367V1.81836H22.1965V6.38355Z"
        fill="#47ED95"
      />
      <defs>
        <linearGradient
          id="paint0_linear_395_205101"
          x1="4.64917"
          y1="8.69963"
          x2="25.1992"
          y2="13.4996"
...
const AddCircleColorIcon = (props) => (
  ...
  >
    <g clipPath="url(#zfktez410a)">
      <path
        d="M6 1C3.24 1 1 3.24 1 6s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm2.5 5.5h-2v2h-1v-2h-2v-1h2v-2h1v2h2v1z"
        fill="#47CC85"
      />
    </g>
    <defs>
...
const GooglePlayIcon = ({ size = 24, ...props }) => (
  ...
  >
    <path
      d="M10.745 12.283.098 23.583a2.873 2.873 0 0 0 4.238 1.741l.034-.02 11.984-6.915-5.61-6.106z"
      fill="#EB4335"
    />
    <path
      d="m21.517 10.36-.01-.006-5.174-3-5.83 5.186 5.85 5.849 5.147-2.97a2.876 2.876 0 0 0 .017-5.059z"
      fill="#FABC13"
    />
    <path
      d="M.098 2.137a2.818 2.818 0 0 0-.098.74v19.967c0 .257.033.505.098.74l11.013-11.011L.098 2.137z"
      fill="#547DBF"
    />
    <path
      d="m10.823 12.86 5.51-5.509L4.364.411A2.878 2.878 0 0 0 .098 2.134v.003L10.823 12.86z"
      fill="#30A851"
    />
  </svg>
);
  ...
  return (
    ...
    >
      <g clipPath="url(#0dcfa1hmna)">
        ...
        <path
          d="M8 2 4 6h3v15h2V6h3L8 2zM16 22l4-4h-3V3h-2v15h-3l4 4z"
          fill={color || "#47CC85"}
        />
      </g>
      <defs>
...
const ArrowRightIcon = ({ color, size }) => (
  ...
  >
    <path
      d="M12.01 3L0 3L0 5L12.01 5L12.01 8L16 4L12.01 0V3Z"
      fill={color || "#47CC85"}
    />
  </svg>
);
...
const BxsBookIcon = ({ size, color, isButton, className, ...props }) => (
  <svg
    {...props}
    className={`${
      !isButton ? (color ? color : "text-[#8694B3]") : ""
    } ${className}`}
    width={size || 12}
    height={size || 12}
    viewBox="0 0 12 12"
...
const PartnersIcon = ({ size, color, ...props }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="m26.279 20.018-2.576 2.569-7.708-7.716a3.616 3.616 0 0 1 3.964-.795c.441.184.841.454 1.178.795l5.142 5.147z"
        fill="#5BD891"
      />
      <path
        d="M10.015 14.817 5.316 19.52l-2.123-2.134 4.699-4.704 2.123 2.135z"
        fill="#9FF2C5"
      />
      <path
        d="m7.892 12.691 2.123 2.126-4.699 4.703-2.123-2.134 4.699-4.695z"
        fill="#9FF2C5"
      />
      <path
        d="m24.095 12.674-2.121 2.123 4.697 4.701 2.121-2.123-4.697-4.701z"
        fill="#5BD891"
      />
      <path
        d="m18.557 17.44-1.284 1.284a3.615 3.615 0 0 1-5.132 0l3.85-3.853 2.566 2.569z"
        fill="#0D994E"
      />
      <path
        d="m15.993 3.204-3.75 3.754 3.75 3.754 3.751-3.754-3.75-3.754z"
        fill="#5BD891"
      />
      <path
        d="m8.249 5.689-1.26 1.26 1.26 1.26 1.259-1.26-1.26-1.26zM23.605 5.685l-1.259 1.26 1.26 1.26 1.258-1.26-1.259-1.26z"
        fill="#0D994E"
      />
    </svg>
  );
...
const CopyIcon = ({ color = "#8694B3", ...props }) => (
  ...
  >
    <g clipPath="url(#piv8lb9sya)">
      <path
        d="M10.665.666H1.332v10.667h1.333V1.999h8V.666zM14 3.333h-10v12h10v-12zm-1.334 10.666H5.332V4.666h7.333v9.333z"
        fill={color}
      />
    </g>
    <defs>
...
const PortfolioIconNoColor = ({ className, color, size = 24 }) => {
  const defaultColor = true ? "#8694B3" : "#47cc85";
...
const SettingIcon = ({ size = 24, color = "#8694B3", ...props }) => (
  ...
  >
    <path
      d="M13 14.727a2.727 2.727 0 1 0 0-5.455 2.727 2.727 0 0 0 0 5.455z"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
...
const FutureSupportIcon = ({ size = 16, className = "", isDark }) => (
  ...
  >
    ...
    />
    <path
      d="M3.814 6.52v.027a4.085 4.085 0 0 0-.054.672v4.92a2.125 2.125 0 0 1-1.317-.485V7.009c.386-.318.871-.491 1.371-.49z"
      fill="#9FF2C6"
    />
    <path
      d="M2.449 7.012v4.643a2.31 2.31 0 0 1-.85-1.815V8.8a2.301 2.301 0 0 1 .85-1.788z"
      fill="#0D994E"
    />
    <path d="M12.711 10.05v3.578H8.26v-.454h3.993V10.05h.458z" fill="#5BD891" />
    <path
      d="M12.188 6.52v.027c.04.221.06.446.058.672v4.92c.481-.009.945-.18 1.317-.485V7.009a2.152 2.152 0 0 0-1.376-.49z"
      fill="#9FF2C6"
    />
    <path
      d="M13.55 7.012v4.643a2.312 2.312 0 0 0 .85-1.815V8.8a2.3 2.3 0 0 0-.85-1.788zM8.263 13.168H7.105v.454h1.158v-.454z"
      fill="#0D994E"
    />
    <path
      d="M8.263 12.8H7.105v.373h1.158v-.372zM8.263 13.61H7.105v.34h1.158v-.34z"
      fill="#9FF2C6"
    />
  </svg>
);
...
const ArrowForwardIcon = ({ size = 24, color = "#fff", className }) => (
  ...
  >
    <path
      d="m8 2.667-.94.94 3.72 3.726H2.665v1.333h8.113l-3.72 3.727.94.94L13.333 8 7.999 2.667z"
      fill={color}
    />
  </svg>
);
  ...
  >
    ...
    <defs>
      <clipPath id="g1zqepm55a">
        <path
          fill="#fff"
          transform="translate(2.666 2)"
          d="M0 0h10.667v12.667H0z"
        />
      </clipPath>
    </defs>
  </svg>
...
const StarPurpleIcon = ({ size, color = "#FFC632", ...props }) => (
  ...
  >
    <path
      d="m8 11.516 4.12 2.487-1.094-4.687 3.64-3.153-4.793-.407L8 1.336l-1.874 4.42-4.793.407 3.64 3.153-1.093 4.687L8 11.516z"
      fill={color}
    />
  </svg>
);
...
const VietnamFlagIcon = ({ size = 24 }) => (
  ...
  >
    <g clip-path="url(#vietnamFlag)">
      ...
      />
      <path
        d="m12 6.26 1.295 3.987h4.191l-3.39 2.463 1.294 3.986L12 14.232l-3.39 2.464 1.295-3.986-3.39-2.463h4.19L12 6.26z"
        fill="#FFDA44"
      />
    </g>
    <defs>
...
const CircularText = () => {
  return (
    <div className="circular-text-container">
      <div className="circular-text-content">
        <span className="circular-text">HCMUS - IDO</span>
      </div>
    </div>
  );
};
...
export const BannerLogo = ({ className }) => {
  return (
    ...
    >
      <path
        d="M118.049 88.6419C117.401 88.3966 116.852 88.0234 116.405 87.5223C115.917 87.0299 115.501 86.4793 115.159 85.8707C114.775 85.2707 114.449 84.6373 114.179 83.9705C113.86 83.2717 113.549 82.6136 113.247 81.9963C113.126 81.4257 113.161 80.9922 113.354 80.6956C113.538 80.3582 113.746 80.0369 113.979 79.7317C114.949 79.4827 115.807 79.2146 116.556 78.9274C117.304 78.6403 118.032 78.3575 118.739 78.079C119.447 77.8006 120.159 77.5425 120.875 77.3048C121.582 77.0263 122.364 76.796 123.22 76.6137C123.562 75.2202 123.877 73.8965 124.164 72.6426C124.442 71.348 124.713 70.1188 124.976 68.9551C125.003 67.8842 125.11 66.8818 125.294 65.9479C125.511 64.9645 125.72 64.0467 125.922 63.1942C126.115 62.3011 126.272 61.437 126.392 60.6019C126.504 59.7261 126.505 58.8313 126.396 57.9173C126.581 56.3869 126.731 54.9916 126.846 53.7317C126.994 52.4223 126.991 50.9105 126.839 49.1963C125.343 49.7705 124.152 50.2797 123.266 50.7238C122.372 51.1272 121.743 51.4741 121.379 51.7647C120.556 51.8975 119.869 51.8733 119.319 51.6922C118.81 51.5024 118.369 51.2341 117.997 50.8873C117.625 50.5405 117.281 50.1239 116.964 49.6375C116.648 49.1511 116.286 48.653 115.879 48.1432C115.964 47.7417 115.892 47.2033 115.663 46.5278C115.426 45.8116 115.068 45.3339 114.591 45.0947C114.9 44.9437 115.088 44.6268 115.156 44.1438C115.215 43.62 115.157 43.2489 114.982 43.0304C115.632 42.6791 116.339 42.4007 117.105 42.195C117.862 41.9487 118.603 41.727 119.328 41.53C120.085 41.2836 120.801 41.0459 121.476 40.8169C122.143 40.5471 122.686 40.1972 123.106 39.767C125.208 39.2342 127.391 38.6841 129.656 38.1167C131.961 37.5405 134.079 36.983 136.009 36.4442C136.795 36.5326 137.656 36.4769 138.594 36.2773C139.572 36.0691 140.543 35.9263 141.506 35.8489C142.51 35.7629 143.422 35.8456 144.243 36.0969C145.104 36.3396 145.785 36.9399 146.288 37.898C146.916 37.8493 147.399 37.9169 147.736 38.1007C148.115 38.2758 148.383 38.538 148.543 38.8874C148.694 39.1961 148.797 39.5789 148.851 40.0359C148.938 40.4434 149.025 40.8509 149.112 41.2585C148.564 41.8864 147.815 42.4718 146.866 43.0