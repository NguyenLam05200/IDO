...
export default function Requests() {
  return (
    <OnlyClient>
      <Typography variant="h4" className="t-title">Requests 📚</Typography>
      {/* Need fix router.push */}
      <Button className="max-w-xs p-[10px] m-[20px]" onClick={() => router.push('./campaigns/[...slug]/requests/new')}>Add Request ➕</Button>
          ...
          <TableBody>
            {rows.map((row) => (
              <StyledTableRow key={row.name}>
                ...
                <StyledTableCell align="left">{row.approvedAccount}</StyledTableCell>
                <StyledTableCell align="left">
                  <Button className="max-w-fit pl-[10px] pr-[10px]" onClick={() => handelApprove()}>Approve</Button>
                </StyledTableCell>
                <StyledTableCell align="left">
                  <Button className="max-w-fit pl-[10px] pr-[10px]" onClick={() => handelFinalize()}>Finalize</Button>
                </StyledTableCell>
              </StyledTableRow>
            ))}
          </TableBody>
